        ...
        <?php endif;?>
                <div class="rel-afisha">
                    ...
                    <div class="rel-afisha-other">
                        ...
                        <div class="map"><?= Yii::t('afisha', 'Where')?> 
                            <?php foreach ($item->companys as $comp):?>
                                <a href="<?= Url::to(['business/view', 'alias' => $comp->id . '-' . $comp->url])?>"><?= $comp->title ?></a>
                            <?php endforeach;?>
                        </div>
                        <div class="time"><?= Yii::t('afisha', 'Time')?> <span><?= $item->getTimes($item->times) ?></span></div>
