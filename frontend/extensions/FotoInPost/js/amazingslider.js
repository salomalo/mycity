...
(function ($) {
    $.fn.ashtml5lightbox = function (options) {
        ...
        inst.options = jQuery.extend({
            ...
            errorwidth: 280,
            errorheight: 48,
            errorcss: "{text-align:left; color:#ff0000; font-size:14px; font-family:Arial, sans-serif;}",
            supportesckey: true,
        ...
        inst.createMarkup = function () {
            ...
            inst.$lightbox = jQuery(
                "<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999998;'>"
                + "<div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:" + inst.options.overlaybgcolor
                + ";opacity:" + inst.options.overlayopacity
                + ";filter:alpha(opacity=" + Math.round(inst.options.overlayopacity * 100) + ");'></div>"
                + "<div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;'>"
                + "<div id='html5-elem-box' style='display:block;position:relative;margin:0px auto;text-align:left;overflow:hidden;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;'>"
                + "<div id='html5-elem-wrap' style='display:block;position:relative;margin:0px auto;text-align:left;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;background-color:"
                + inst.options.bgcolor + ";'>"
                + "<div id='html5-loading' style='display:none;position:absolute;top:0px;left:0px;text-align:left;width:100%;height:100%;background:url(\""
                + inst.options.skinsfolder + inst.options.loadingimage
                + "\") no-repeat center center;'></div>"
                + "<div id='html5-error' class='html5-error' style='display:none;position:absolute;padding:" + inst.options.bordersize
                + "px;text-align:left;width:" + inst.options.errorwidth
                + "px;height:" + inst.options.errorheight + "px;'>"
                + "The requested content cannot be loaded.<br />Please try again later."
                + "</div>"
                + "<div id='html5-image' style='display:none;position:absolute;top:0px;left:0px;padding:" + inst.options.bordersize
                + "px;text-align:left;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;'></div>"
                + "<div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:"
                + inst.options.bordersize
                + "px;top:50%;margin-top:-16px;'><img src='" + inst.options.skinsfolder + inst.options.nextimage + "'></div>"
                + "<div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + inst.options.bordersize
                + "px;top:50%;margin-top:-16px;'><img src='" + inst.options.skinsfolder + inst.options.previmage
                + "'></div>"
                + "</div>"
                + "</div>"
                + "<div id='html5-watermark' style='display:none;position:absolute;left:" + String(inst.options.bordersize + 2)
                + "px;top:" + String(inst.options.bordersize + 2) + "px;'></div>"
                + "</div>"
                + "</div>");
            ...
            if (inst.options.stamp)inst.$watermark.html("<a href='" + inst.options.freelink + "' style='text-decoration:none;' title='jQuery Lightbox'><div style='display:block;width:100px;height:20px;text-align:left;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:12px Arial,sans-serif;'><div style='line-height:20px;'>" +
        ...
        inst.embedFlash = function ($container, src, wmode, flashVars) {
            ...
            } else $container.html("<div class='html5lightbox-flash-error' style='display:block; position:relative;text-align:left; width:100%; left:0px; top:40%;'><div class='html5-error'><div>The required Adobe Flash Player plugin is not installed</div><br /><div style='display:block;position:relative;text-align:left;width:112px;height:33px;margin:0px auto;'><a href='http://www.adobe.com/go/getflashplayer'><img src='http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif' alt='Get Adobe Flash player' width='112' height='33'></img></a></div></div>")
        };
    ...
    $.fn.amazingslider = function (options) {
        ...
        AmazingSlider.prototype = {
            initData: function (onSuccess) {
                ...
                if (this.lightboxArray.length > 0) {
                    ...
                    for (i = 0; i < this.lightboxArray.length; i++)this.html5Lightbox.addItem(this.lightboxArray[i][ELEM_LINK],
                        this.lightboxArray[i][ELEM_TITLE], "amazingslider" + this.id, this.lightboxArray[i][ELEM_LIGHTBOXWIDTH], this.lightboxArray[i][ELEM_LIGHTBOXHEIGHT], this.lightboxArray[i][ELEM_WEBM], this.lightboxArray[i][ELEM_OGG], this.lightboxArray[i][ELEM_THUMBNAIL], this.lightboxArray[i][ELEM_DESCRIPTION]);
                    var instance = this;
                ...
                $(".amazingslider-box-" + this.id, this.container).append('<div style="' + stylecode + '">' + html +
                    "</div>")
                ...
                this.$wrapper = jQuery("" + "<div class='amazingslider-wrapper-" + this.id + "'>" + "<div class='amazingslider-background-image-" + this.id + "'></div>" + "<div class='amazingslider-slider-" +
                    ...
                    this.id + "'></div>" + "<div class='amazingslider-ribbon-" + this.id + "'></div>" + "<div class='amazingslider-arrow-left-" + this.id + "'></div>" + "<div class='amazingslider-arrow-right-" + this.id + "'></div>" + "<div class='amazingslider-timer-" + this.id + "'></div>" + "</div>" + "<div class='amazingslider-nav-" + this.id + "'><div class='amazingslider-nav-container-" + this.id + "'></div></div>" + "</div>");
                ...
                if (type ==
                    TYPE_VIDEO_YOUTUBE)this.playYoutubeVideo(href, autoplay); else if (type == TYPE_VIDEO_VIMEO)this.playVimeoVideo(href, autoplay); else if (type == TYPE_VIDEO_MP4) {
                ...
                var isHTML5 = true;
                if (ASPlatforms.isIE6789())isHTML5 = false; else if ((ASPlatforms.isFirefox() ||
                    ASPlatforms.isOpera()) && !webmhref)isHTML5 = false;
                if (isHTML5) {
                ...
                if (ASPlatforms.flashInstalled()) {
                    ...
                    for (var key in htmlOptions)htmlString += key + "=" + htmlOptions[key] + " ";
                    $container.html("<embed " + htmlString + "/>")
                } else $container.html("<div class='amazingslider-error-" + this.id + "' style='display:block; position:absolute; text-align:left; width:" + this.options.width +
                ...
                if (ASYouTubeIframeAPIReady && !ASPlatforms.isIE6() && !ASPlatforms.isIE7() && !ASPlatforms.isIOS() && !ASPlatforms.isAndroid()) {
                    ...
                    new YT.Player("amazingslider-video-" + this.id, {
                        width: instance.options.width, height: instance.options.height, videoId: id, playerVars: {
                            "html5": 1,
                            "autoplay": 1,
                            "rel": 0,
                            "autohide": 1,
                            ...
                            "showinfo": instance.options.videohidecontrols ?
                                "0" : "1"
                        }, events: {
            ...
            checkVideoType: function (href) {
                ...
                this.container.bind("amazingslider.switchtext", function (event, prev, cur) {
                    ...
                    if (instance.textoptions.texteffectresponsive)textHeadCss += "@media (max-width: " +
                        instance.textoptions.texteffectresponsivesize + "px) {" + ".amazingslider-title-" + instance.id + " {" + instance.textoptions.titlecssresponsive + "} " + ".amazingslider-description-" + instance.id + " {" + instance.textoptions.descriptioncssresponsive + "} " + ".amazingslider-button-" + instance.id + " {" + instance.textoptions.buttoncssresponsive + "} " + "} ";
                    textHeadCss += "</style>";
            ...
            resizeSlider: function () {
                ...
                this.container.css({
                    "width": this.options.width, "height": this.options.navdirection ==
                    "horizontal" && this.options.navmultirows ? "auto" : this.options.height
                });
                if (this.options.navthumbnavigationstyle != "auto") {
                    ...
                    if (this.options.navmultirows) {
                        ...
                        if (this.options.navdirection == "vertical") {
                            ...
                            if (l <= $navContainer.width() - $bulletWrapper.width())l = $navContainer.width() -
                                $bulletWrapper.width();
                            if (l >= 0)l = 0;
                ...
                styleCss += "}";
                styleCss += ".amazingslider-box-" + this.id +
                ...
                styleCss += ".amazingslider-video-wrapper-" +
                    this.id + " {display:none;position:absolute;left:0px;top:0px;background-color:#000;text-align:left;}";
                ...
                if (this.options.showribbon) {
                    ...
                    switch (this.options.ribbonposition) {
                        ...
                        case "bottom":
                            styleCss += "width:100%;height:auto;text-align:left;bottom:" +
        ...
        this.each(function () {
            ...
            var defaultOptions = {
                ...
                elastic: {
                    duration: 1E3, easing: "easeOutElastic",
                ...
                threed: {
                    checked: true, effectdirection: 0, bgcolor: "#222222", perspective: 1E3, slicecount: 5,
                    duration: 1500, easing: "easeOutCubic", fallback: "slice", scatter: 5, perspectiveorigin: "right"
                },
