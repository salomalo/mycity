                    ...
                    <div id="primary">
                        <div class="content">
                            ...
                            <div class="listing-detail">
                                ...
                                <div class="listing-detail-section" id="listing-detail-section-proposition">
                                    <h2 class="page-header"><?= Yii::t('vacantion', 'Our_proposition') ?></h2>

                                    <div class="listing-detail-description-wrapper">
                                        <div><?= Html::decode($model->proposition) ?></div>
                                    </div>
                                </div>

                                <?= CommentsSuperlist::widget(['id' => $model->id, 'type' => File::TYPE_WORK_VACANTION]) ?>
                            </div>
