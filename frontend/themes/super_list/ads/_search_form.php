...
<div id="filter-3" class="widget widget_filter">
    <div class="widget-inner widget-pb">
        ...
        <?= Html::beginForm(['/search/index'], 'get', ['id' => 'find_business1']) ?>

        <?= Html::hiddenInput('type', 5) ?>
                    ...
                    <ul>
                        ...
                        <li>
                            <?= Html::a(
                                ...
                                ($sort === 'rating' ? null : Url::current(['sort' => 'rating'])),
                                [
                                    'class' => 'a-sorting-inner-group-types' . ($sort === 'rating' ? ' active' : ''),
                                    'title' => Yii::t('business', 'Rating'),
                                ]
                            ) ?>
                        </li>
                    </ul>
