                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body our-modal-body">
                            ...
                            <?= $form->field($model, 'login', [
                                    ...
                                    'inputOptions' => ['placeholder' => 'Ваш login...', 'class' => 'modal-inpu form-control']
                                ]
                            ...
                            <?= $form->field($model, 'password', [
                                'template' => "{error}\n{input}\n{label}\n{hint}\n",
                                'errorOptions' => ['class' => 'help-block-modal'],
                                'inputOptions' => ['placeholder' => 'Ваш пароль...', 'class' => 'modal-input form-control']
                            ...
                            <div class="modal-footer our-modal-footer">
                                <div class="form-group our-form-group">
                                    ...
                                    <?= Html::submitButton(Yii::t('app', 'Login_to_your_account'), ['class' => ' btn new-modal-button but-l new-login-button', 'name' => 'login-button']) ?>
