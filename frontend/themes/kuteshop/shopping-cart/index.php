            ...
            <div id="primary">
                ...
                <div class="cart-checkout">
                    <div class="cart-checkout-navigation">
                        <ul class="cart-checkout-navigation-list" role="tablist">
                            <li class="active">
                                <a href="#review-order" role="tab" data-toggle="tab" aria-controls="review-order"
                                   aria-expanded="true" class="cart-checkout-navigation-list-item-link"
                                   style="pointer-events: none;">
                                    Корзина
                                </a>
                            </li>
                            <li>
                                <a href="#dellivery" role="tab" data-toggle="tab" aria-controls="dellivery"
                                   aria-expanded="true" class="cart-checkout-navigation-list-item-link"
                                   style="pointer-events: none;">
                                    Доставка
                                </a>
                            ...
                            <?php if (!Yii::$app->user->identity) : ?>
                                <li>
                                    <a href="#fast-register" role="tab" data-toggle="tab" aria-controls="fast-register"
                                       aria-expanded="true" class="cart-checkout-navigation-list-item-link"
                                       style="pointer-events: none;">
                ...
                <div class="container">
                    ...
                    <div class="cart-checkout-content tab-content">
                        ...
                        <div id="review-order" role="tabpanel" class="tab-pane fade active in"
                             aria-labelledby="review-order-tab">
                                ...
                                <table class="cart-list" id="table-cart-list">
                                    ...
                                    <tr>
                                        <th colspan="5" class="cart-list-item-total">
                                            ...
                                            <span class="cart-list-item-amount" id="sumAllItem"><?= $total ?>
                                                грн.</span>
                                        </th>
                                    </tr>
                                    </tfoot>
                                </table>
                                <a href="<?= Url::to(['/shopping-cart/clear-shopping-cart']) ?>"
                                   class="del btn btn-solid" onClick="return window.confirm('Вы уверены?');"
                                   id="clear-basket">
                                    Очистить корзину
                                </a>
