...
<div class="post-view">
    ...
    <p>
        <?= Html::a('Обновить', ['update', 'id' => $model->id, 'idCompany' => $business->id], ['class' => 'btn btn-primary']) ?>
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            'user.username:text:Пользователь',
            'shortText:html:Краткое описание',
            'fullText:html:Полный текст',
            ...
            ['attribute' => 'video', 'value' => $model->getVideos($model->video)],
        ],
    ]) ?>
