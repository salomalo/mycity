        ...
        !function () {
            ...
            function o(e, t, o, n) {
                ...
                if (M.push({x: t, y: o, lastX: 0 > t ? .99 : -.99, lastY: 0 > o ? .99 : -.99, start: +new Date}), !T) {
                    var l = e === document.body, u = function () {
                        for (var r = +new Date, a = 0, i = 0, c = 0; c < M.length; c++) {
                            var s = M[c], d = r - s.start, f = d >= v.animationTime, h = f ? 1 : d / v.animationTime;
                            v.pulseAlgorithm && (h = p(h));
                            var m = s.x * h - s.lastX >> 0, w = s.y * h - s.lastY >> 0;
            ...
            function r(e) {
                var t = e.target, n = e.ctrlKey || e.altKey || e.metaKey || e.shiftKey && e.keyCode !== H.spacebar;
            ...
            function f(e) {
                if (e) {
                    ...
                    var t = D[0] == D[1] && D[1] == D[2], o = h(D[0], 120) && h(D[1], 120) && h(D[2], 120);
                    return !(t || o)
                }
            }
            ...
            var w, g = {
                frameRate: 150,
                animationTime: _this.options.smoothScrollSpeed,
                stepSize: 120,
                pulseAlgorithm: !0,
                pulseScale: 8,
                pulseNormalize: 1,
