...
<div class="action-category-form">
    ...
    <?php if($model->image):?>
        ...
        <a href="<?= Yii::$app->urlManager->createUrl(['action-category/update', 'id' => $model->id, 'actions'=>'deleteImg'])?>" title="Delete" data-confirm="Are you sure you want to delete this item?" ><span class="glyphicon glyphicon-trash"></span></a>
    <?php endif;?>
