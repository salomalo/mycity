...
<div class="comment-form">
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-success comment-btn">
...
<p>
    <br>
    <h3><?= Yii::t('widgets', 'only_authorized_{authorized}', [
        'authorized' => Html::a(Yii::t('widgets', 'authorized'), ['/'], [
            'onclick' => 'login("' . \Yii::$app->urlManager->createUrl("/user/security/login-ajax") . '");return false;'
        ])
    ]) ?>
    </h3>
</p>
