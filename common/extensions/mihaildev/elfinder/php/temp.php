...
class elFinderVolumeS3 extends elFinderVolumeDriver {
	...
	protected function init() {
		...
		$this->rootName = 's3';
                ...
                //echo \yii\helpers\BaseVarDumper::dump($this, 10, true); die('this'); 
	...
	protected function _dirname($path) {
		...
		//echo \yii\helpers\BaseVarDumper::dump($dn, 10, true); die('$dn'); 
		return $dn;
	}
	...
	protected function _basename($path) {
            //echo \yii\helpers\BaseVarDumper::dump($path, 10, true); die('$path'); 
	...
	protected function _normpath($path) {
		...
		$tmp =  preg_replace("/\/$/", "", $tmp);
                //echo \yii\helpers\BaseVarDumper::dump($tmp, 10, true); die('$tmp'); 
		return $tmp;
	}
	...
	protected function _relpath($path) {
		...
		//echo \yii\helpers\BaseVarDumper::dump($ret, 10, true); die('$ret'); 
		return $ret;
	}
		...
		if ($stat['mime'] == 'directory') {
		 ...
		 foreach ($files as $file) {
			$fstat = $this->_stat($file);
                        //echo \yii\helpers\BaseVarDumper::dump($fstat, 10, true); die('$fstat');
