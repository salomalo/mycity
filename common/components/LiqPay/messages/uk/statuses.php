...
return [
    ...
    LiqPayStatuses::SUBSCRIBED => 'Підписка успішно оформлена',
    LiqPayStatuses::UNSUBSCRIBED => 'Підписка успішно деактивовано',
    ...
    LiqPayStatuses::PROCESSING => 'Платіж обробляється',
    ...
    LiqPayStatuses::WAIT_ACCEPT => 'Гроші з клієнта списані, але магазин ще не пройшов перевірку',
    LiqPayStatuses::WAIT_LC => 'Акредитив. Гроші з клієнта списані, очікується підтвердження доставки товару',
